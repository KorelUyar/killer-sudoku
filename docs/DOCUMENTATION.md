...
> **Hinweis:** Diese Bilder sind statische Design-Mockups, die den **angestrebten visuellen Endzustand** zeigen. Die laufende Applikation kann in Details abweichen — z. B. enthalten die Mockups beispielhafte Cage-Layouts, Leaderboard-Einträge fiktiver User (`mastrandrea`, `jvogel`, `darian_42` etc.) und Beispiel-Zeiten, die in der realen App naturgemäß anders aussehen. Aktuelle Live-Screenshots finden sich im GitHub-README unter <https://github.com/KorelUyar/killer-sudoku> bzw. unter <https://sudobattles.com>.
